...
{
    public class BaseServices<TEntity> : IServices.IBaseServices<TEntity> where TEntity : class, new()
    {
        // public IBaseRepository<TEntity> baseDal = new BaseRepository<TEntity>();
        public IBaseRepository<TEntity> baseDal; //通过子类在构造函数中注入，这里是基类，不用构造函数
